...
function ColumnContainer({
  ...
  if (isDragging) {
    ...
    >
      ...
      {/* You can use IconButton instead if you prefer an icon for the button */}
      {/* <IconButton
        style={{
          color: 'white',
          borderColor: 'yellow',
    ...
    //     ref={setNodeRef}
    //     style={style}
    //     className="bg-blue-450  w-[50px] h-[500px] max-h-[500px] rounded-md flex flex-col"
    //   ><button
    //   className="gap-10 items-center text-white border-yellow-500 border-2 rounded-md p-4 border-x-yellow-500 hover:bg-[green] hover:text-yellow-500 active:bg-black"
    //   onClick={() => setModal(true)}
    // >
    //   Add task ➕
    // </button></div>
